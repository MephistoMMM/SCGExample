...
module Jekyll
  ...
  class IconPage < Page
    ...
    ##
    # Take weatherDataUtils single icon and render weatherDataUtils page for it.
  ...
  class IconGenerator < Generator
    ...
    ##
    # Iterate over every described icon in weatherDataUtils YAML file and create weatherDataUtils page for it
